...
\frame{\frametitle{Conventional Corpus Design}
    \begin{itemize} 
        ...
        \item Reliant on expert opinion for proportionality
    ...
    \note{
        Hoey: "A corpus represent's no-one's experience of language"\\
        Biber: "A new approach to representativeness", "cannot be proportional"\\
    ...
    \begin{center}
        \begin{figure}
            ...
            \begin{subfigure}[b]{4cm}
                \centering
                \includegraphics[width=\textwidth]{dictaphone}
            \end{subfigure}%
            ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc.
            %(or a blank line to force the subfigure onto a new line)
            \begin{subfigure}[b]{0.35\textwidth}
                \centering
                \includegraphics[width=\textwidth]{clicked}
            \end{subfigure}
        \end{figure}
    \end{center}
...
% 
% 
% \frame{\frametitle{Technical---Other}
% 
%     \begin{columns}[t]
%         \column{.6\textwidth}
% 
%         \begin{itemize}
%             \item Files uploaded to journal
%                 \vspace{5pt}
%             \item Email sorted by date
%                 \vspace{5pt}
%             \item Web chat handled by custom bot
%         \end{itemize}
% 
%         \column{.4\textwidth}
%     \begin{center}\includegraphics[width=4cm]{wik}\end{center}
%     \end{columns}
% 
%     \note{}
% }
...
\end{figure}
    ...
    \begin{itemize}
        \item 15 days with full availabilty
            \vspace{5pt}
        \item $8,619$ linguistic events, $0.98$m words (est.), 3.4GB
        % T ODO
    \end{itemize}
\note{}
}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item 68 genres with over 5 events $\rightarrow$
                \vspace{5pt}
            \item Thick tail indicates minimum functional length $\approx 5$ words
        \end{itemize}
